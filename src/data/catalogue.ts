...
export const catalogueImage = (item: CatalogueItem): string => {
  const CDN_BASE = "https://cdn.example.com"; // Replace with actual CDN URL
  const webpPath = item.image.replace(/\.(jpg|jpeg|png)$/i, ".webp");
