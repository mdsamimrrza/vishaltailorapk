...
// Branded map placeholder used on native. A live react-native-maps Google
// map renders as a black rectangle in APK builds without an API key
// (android.config.googleMaps.apiKey in app.json), so we draw the same
// stylized map as web instead — identical on Android and iOS, no key needed.
export default function ContactMap({ onPress }: { onPress: () => void }) {
  return (
